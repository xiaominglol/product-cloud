package com.gemini.business.admin.common.aop;
...
import com.gemini.business.admin.common.utils.IPUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.gemini.business.admin.common.annotation.SysLog)")
    public void sysLog() {
