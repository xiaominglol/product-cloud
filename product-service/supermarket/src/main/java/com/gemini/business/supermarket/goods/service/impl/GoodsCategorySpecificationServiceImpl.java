...
import com.gemini.business.supermarket.goods.mapper.GoodsSpecificationMapper;
import com.gemini.business.supermarket.goods.po.GoodsCategorySpecificationPo;
import com.gemini.business.supermarket.goods.service.GoodsCategorySpecificationService;
 ...
 */
@Service
public class GoodsCategorySpecificationServiceImpl extends BaseServiceImpl<GoodsCategorySpecificationPo, GoodsSpecificationMapper> implements GoodsCategorySpecificationService {

    @Override
    public QueryWrapper<GoodsCategorySpecificationPo> wrapper(GoodsCategorySpecificationPo po) {
