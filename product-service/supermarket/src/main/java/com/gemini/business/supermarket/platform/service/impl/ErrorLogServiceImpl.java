 ...
 */
@Service
public class ErrorLogServiceImpl extends BaseServiceImpl<ErrorLogPo, ErrorLogMapper> implements ErrorLogService {

    @Override
    public QueryWrapper<ErrorLogPo> wrapper(ErrorLogPo po) {
